...
{
    public class OracleModelGenerator
    {
        protected string _namespace;
        protected SqlConnection _connection;

        public OracleModelGenerator(string @namespace, SqlConnection connection)
        {
        ...
        public List<String> GenerateNamespace(bool explicitKeys = false)
        {
            ...
            {
                var list = GenerateClass(name, explicitKeys);
                strings.AddRange(list.Select(l => "\t" +  l));
            }
            strings.Add("}");
